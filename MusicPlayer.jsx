        ...
        <div className='w-full flex items-center gap-3'>
            <div className={`w-full items-center gap-3 p-4 flex relative`}>
                ...
                <div className='flex items-start flex-col'>
                    <p className="text-xl text-textColor2 font-semibold">
                    ...
                    <p className="text-textColor2">
                        ...
                        <span className="text-sm text-textColor2 font-semibold">
                    ...
                    >
                        <RiPlayListFill className="text-textColor2 hover:text-headingColor2 text-3xl cursor-pointer" />
                    </motion.i>
                </div>
...
export const PlayListCard = () => {
    ...
    return (
        ...
        scrollbar-thin rounded-md shadow-md bg-primary'>
            {allSongs.length > 0 ? (allSongs.map((music, index) => (
                <motion.div
                    ...
                    key={index}
                >
                    <IoMusicalNote className="text-textColor2 group-hover:text-headingColor2 text-2xl cursor-pointer" />

                    <div className="flex items-start flex-col">
                        <p className="text-lg text-headingColor2 font-semibold">
